...
{
    public class Default12Controller : Controller
    {
        ...
        // GET: /Default12/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: /Default12/Create
